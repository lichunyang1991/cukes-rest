...
public class ThenSteps {
    ...
    @Then("^let variable \"([^\"]+)\" equal to jsonPath \"([^\"]+)\" value$")
    public void var_assigned_fromJsonPath(String varName, String property) {
        assertionFacade.varAssignedFromJsonPath(varName, property);
    }
    
    @Then("^let variable \"([^\"]+)\" equal to mobile jsonPath \"([^\"]+)\" value$")
    public void var_assigned_fromMobileJsonPath(String varName, String property) {
        assertionFacade.varAssignedFromMobileJsonPath(varName, property);
    }
    ...
    @Then("^mobile response contains \"(.+)\"$")
    public void mobile_response_Body_Contains(String body) {
        assertionFacade.mobileBodyContains(body);
    }
    ...
    @Then("^mobile response not contains \"(.+)\"$")
    public void mobile_response_Body_Not_Contains(String body) {
        assertionFacade.mobileBodyNotContains(body);
    }
    ...
    @Then("^response contains property \"(.+)\" containing integer content \"(.*)\"$")
    public void response_Body_Contains_Property_With_Content(String jsonPath, int value) {
        assertionFacade.bodyContainsJsonPathValueContainingIntegerContent(jsonPath, value);
    }
    
    @Then("^mobile response contains property \"(.+)\" containing String content \"(.*)\"$")
    public void mobile_response_Body_Contains_Property_With_Content(String jsonPath, String value) {
        assertionFacade.mobileBodyContainsJsonPathValueContainingStringContent(jsonPath, value);
    }
    
    @Then("^mobile response xml body contains property \"(.+)\" containing String content \"(.*)\"$")
    public void mobile_response_xml_Body_Contains_Property_With_Content(String key, String value) {
        assertionFacade.mobileXMLBodyContainsElementKeyValueContainingStringContent(key, value);
    }
    ...
    public String getResponseContent() {
    	System.out.println("getResponseContent==  "+assertionFacade.getResponseContent());
        return assertionFacade.getResponseContent();
    }
    
    @Then("^response contentType is$")
    public String getResponseContentType() {
    	System.out.println("getResponseContentType==  "+assertionFacade.getResponseContentType());
        return assertionFacade.getResponseContent();
    }
